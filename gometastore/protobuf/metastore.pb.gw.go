...
var (
	filter_Metastore_GetTable_0 = &utilities.DoubleArray{Encoding: map[string]int{"id": 0, "catalog": 1, "db_id": 2, "name": 3}, Base: []int{1, 1, 1, 4, 2, 0, 0, 4, 0}, Check: []int{0, 1, 2, 1, 2, 3, 5, 4, 8}}
)
...
var (
	...
	pattern_Metastore_GetTable_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"v2", "table", "id.catalog", "db_id.name", "id.name"}, ""))
)
